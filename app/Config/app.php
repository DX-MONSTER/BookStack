...
return [
    ...
    // and used by App in URL generation.
    'url' => env('APP_URL', '') === 'http://bookstack.dev' ? '' : env('APP_URL', ''),

    // A list of hosts that App can be iframed within.
    // Space separated if multiple. App host domain is auto-inferred.
    'iframe_hosts' => env('ALLOWED_IFRAME_HOSTS', null),

    // A list of sources/hostnames that can be loaded within iframes within App.
    // Space separated if multiple. App host domain is auto-inferred.
    ...
    // Alter the precision of IP addresses stored by App.
    ...
    'providers' => [
        ...
        App\Providers\ViewTweaksServiceProvider::class,
    ],
