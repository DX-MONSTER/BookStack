...
return [
    ...
    'color_scheme_desc' => '设置要在 App 界面中使用的颜色。 可以为深色和浅色模式分别配置颜色，以适合主题并确保易读性。',
    'ui_colors_desc' => '设置 App 的主颜色和默认链接颜色。主颜色主要用于页眉横幅、按钮和界面装饰。默认链接颜色用于基于文本的链接和操作，包括编写界面和 Bookstack 界面。',
    'app_color' => '主颜色',
    'link_color' => '默认链接颜色',
